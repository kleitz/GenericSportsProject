<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmClubMember.ascx.cs" Inherits="DotNetNuke.Modules.ThSport.frmClubMember" %>
...
<style type="text/css">
 ...
 <script type="text/javascript">
     function validateAndConfirmClose(OnlyClose) {
         ...
         if (OnlyClose == "btnCancelClubMember") {
             document.getElementById("msgConfirm").innerHTML = "Are You Sure, You Want to Close ClubMember Form ?";
         }
             ...
             $("#dialogBox").dialog({
                 ...
                 buttons: {
                     Ok: function () {
                         ...
                         if (OnlyClose == "btnCancelClubMember")
                         {
                             <%=this.Page.ClientScript.GetPostBackEventReference(new PostBackOptions(this.btnCancelClubMember))%>;
                         }
     ...
     function validateAndConfirm(btn_clientid) {
         ...
         if (btn_clientid == "btnUpdateClubMember") {
             document.getElementById("msgConfirm").innerHTML = "Are You Sure, You Want to Update ClubMember Details ?";
         }
             ...
             $("#dialogBox").dialog({
                 ...
                 buttons: {
                     Ok: function () {
                         ...
                         if (btn_clientid == "btnSaveClubMember")
                         {
                             <%=this.Page.ClientScript.GetPostBackEventReference(new PostBackOptions(this.btnSaveClubMember))%>;
                         }

                         if (btn_clientid == "btnUpdateClubMember")
                         {
                             <%=this.Page.ClientScript.GetPostBackEventReference(new PostBackOptions(this.btnUpdateClubMember))%>;
                         }
...
<div id="divsavemassage" runat="server" clientidmode="static" style="display: none;position:inherit !important;">
    <img src="<%= Page.ResolveUrl("~/DesktopModules/ThSport/Images/AllImage/Ok.png")%>" />
     <asp:Label CssClass="lobibox-body-text" ID="Label1" ClientIDMode="Static" runat="server" Text=" ClubMember detail are save successfully. ">
     </asp:Label>
</div>

<div id="divupdatemassage" runat="server" clientidmode="static" style="display: none;position:inherit !important;">
    <img src="<%= Page.ResolveUrl("~/DesktopModules/ThSport/Images/AllImage/Ok.png")%>" />
     <asp:Label CssClass="lobibox-body-text" ID="Label2" ClientIDMode="Static" runat="server" Text=" ClubMember detail are update successfully. ">
     </asp:Label>
</div>
...
<div id="divcancelmassage" runat="server" clientidmode="static" style="display: none;position:inherit !important;">
    <img src="<%= Page.ResolveUrl("~/DesktopModules/ThSport/Images/AllImage/Cancel.png")%>" />
     <asp:Label CssClass="lobibox-body-text" ID="Label3" ClientIDMode="Static" runat="server" Text=" ClubMember detail are delete successfully. ">
     </asp:Label>
</div>

<div id="dialogBox" runat="server" clientidmode="static"  style="display:none;">
    <div class="lobibox-body-text-wrapper">
        <asp:Label CssClass="lobibox-body-text" ID="msgConfirm" ClientIDMode="Static" runat="server" Text="Are You Sure, You Want to Save ClubMember Details ?"></asp:Label>
    </div>
</div>
...
<div class="row-fluid">
   ...
   <panel id="pnlClubMemberGrid" runat="server">

    <asp:Panel ID="addPanel" runat="server">    
        <div id="submenu">
            <ul>
                <li class="active">
                    <asp:LinkButton ID="btnAddClubMember" runat="server" 
                                    Height="35px" Text=" Add Member " 
                                    onclick="btnAddClubMember_Click" ForeColor="White"/>
                </li>
            </ul>
        </div>
    ...
    <div class="portlet box green">
			...
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="hidden-480"> <asp:Label ID="lbl_Club_Member" runat="server"></asp:Label> - Club Member List</span>
				</div>
                <div class="tools">
    ...
    <div class="portlet-body flip-scroll">
          ...
          <asp:GridView ID="gvClubMember" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" 
                        ...
                        onpageindexchanging="gvClubMember_PageIndexChanging">
            <RowStyle CssClass="grid-row" />
        <AlternatingRowStyle CssClass="grid-row grid-row-alternet" />

		<Columns>

        <asp:TemplateField HeaderText="ClubMemberId" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" 
                ...
                <ItemTemplate>
                    <div class="grid-cell-inner" style="width:130px; display: inline-block;">
                        <asp:Label ID="lblClubMemberId" runat="server" Text='<%#Eval("ClubMemberId") %>'></asp:Label>
                    </div> 
                </ItemTemplate>
         </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Member Type" HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column" ItemStyle-HorizontalAlign="Center">
				<ItemTemplate>
                    <div class="grid-cell-inner" style="text-align:center;">
					    <asp:Label ID="lblMemberType" runat="server" Text='<%#Eval("ClubMemberTypeValue") %>' ToolTip=" Club Member Type "></asp:Label>
                    </div> 
				</ItemTemplate>
			</asp:TemplateField>

            <asp:TemplateField HeaderText="Member Title" HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column" ItemStyle-HorizontalAlign="Center">
				<ItemTemplate>
                    <div class="grid-cell-inner" style="text-align:center;">
					    <asp:Label ID="lblMemberTitle" runat="server" Text='<%#Eval("ClubMemberTitle") %>' ToolTip=" Club Member Title"></asp:Label>
                    </div> 
				</ItemTemplate>
			</asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="Action"  HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column" 
                ...
                <ItemTemplate>
                    <asp:DropDownList ID="ddlAction" runat="server" CssClass="small m-wrap ddlActionSelect" 
                        ...
                        <asp:Label ID="lblddlActionClubMemberId" runat="server" Text='<%#Eval("ClubMemberId") %>' Visible="false">
                        </asp:Label>
...
<asp:Panel ID="pnlClubMemberEntry" runat="server">
    ...
    <div class="portlet box blue tabbable">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-reorder"></i>
					<span class="hidden-480">Club Member Detail</span>
				</div>
			</div>
    ...
    <div class="tab-content" style="margin-top:10px !important;">
        ...
        <div style="width: 100%;margin-top:20px;">
           ...
           <div class="control-group">
		     <label class="control-label">
                   <asp:Label ID="lblClubMemberType" runat="server" Text=" Member Type :" ></asp:Label>
             </label>
       ...
       <div class="control-group">
		     <label class="control-label">          
                   <asp:Label ID="lblClubMemberTitle" runat="server" Text=" Member Title :" ></asp:Label>
             </label>
             <div class="startsetallfrom">
                 <span class="help-inline"><font Color="red"><b>*</b></font></span>
             </div>
             <div class="controls" style="position:relative;">
                  <asp:TextBox ID="txtClubMemberTitle" runat="server" CssClass="m-wrap large"/>
                  <asp:RequiredFieldValidator ID="rfvtxtClubMemberTitle" runat="server" ErrorMessage="ClubMember"  
                                                ControlToValidate="txtClubMemberTitle" SetFocusOnError="true" 
                                                ValidationGroup="Sports" Text=" Club Member Title Required !" CssClass="errorfordnn" ClientIDMode="Static"/>
                   <asp:RegularExpressionValidator ID="rgvtxtClubMemberTitle"
                                                    Display="Static" ControlToValidate="txtClubMemberTitle"  
                                                    ValidationGroup="Sports" CssClass="errorfordnn"
                                                    ValidationExpression = "^[\s\S]{0,100}$" 
                                                    runat="server" ErrorMessage="Maximum 100 characters allowed.">
                   </asp:RegularExpressionValidator>  
                   <asp:CustomValidator ID="cvtxtClubMemberTitle" ValidationGroup="Sports" runat="server" ErrorMessage="" SetFocusOnError="true" 
                                                 ControlToValidate="txtClubMemberTitle" EnableClientScript="true" ClientValidationFunction="validateTextBox" 
       ...
       <div class="control-group">
        ...
        <div class="form-actions">
            <div class="right_div_css">
                    ...
                    <asp:Button ID="btnSaveClubMember" runat="server"  Text=" Save " OnClick="btnSaveClubMember_Click" 
                                ValidationGroup="Sports" CssClass="btn blue" ClientIDMode="Static" Width="100px"
                                OnClientClick="return validateAndConfirm(this.id);" />

                    <asp:Button ID="btnUpdateClubMember" runat="server"  Text=" Update " OnClick="btnUpdateClubMember_Click" 
                                ValidationGroup="Sports" CssClass="btn red" ClientIDMode="Static" Width="100px"
                                OnClientClick="return validateAndConfirm(this.id);" />

                    <asp:Button ID="btnCancelClubMember" runat="server" Text="Cancel" OnClick="btnCancelClubMember_Click" CssClass="btn" 
