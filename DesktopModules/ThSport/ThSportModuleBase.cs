...
namespace DotNetNuke.Modules.ThSport
{
    ...
    /// are accessible to your module's controls (that inherity from ThSportModuleBase
    /// 
    /// </summary>

    public class ThSportModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
