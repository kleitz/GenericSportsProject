    ...
    <div class="tab-content" style="margin-top:10px !important;">
       ...
       <div class="control-group">
             ...
             <div class="controls" style="position:relative;">
                  <asp:TextBox ID="txtClubOwnerName" runat="server" 
                                     CssClass="m-wrap large" onchange="textBoxOnBlur(this,this.id)" 
                                     ClientIDMode="Static"/>
                  <asp:RequiredFieldValidator ID="rfvClubOwnerName" runat="server" ErrorMessage="Club Owner Name,"
                                              ControlToValidate="txtClubOwnerName" SetFocusOnError="true" 
                                              ValidationGroup="Sports" Text="Owner Name Required !" 
        ...
        <div class="control-group">
         ...
         <div class="control-group">
		    ...
		    <div class="controls">
                   <asp:TextBox ID="txtClubOwnerPercentage" CssClass="m-wrap small" runat="server" maxlength="3"></asp:TextBox>%
            </div> 
        </div>
