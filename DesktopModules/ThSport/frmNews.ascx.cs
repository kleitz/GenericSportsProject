...
namespace DotNetNuke.Modules.ThSport
{
    public partial class frmNews : PortalModuleBase
    {
        ...
        protected void btnSaveNews_Click(object sender, EventArgs e)
        {
            ...
            {
                cs.NewsOtherVideoPath = imhpathDB + NewsVideoLogoFile.PostedFile.FileName.Replace(" ", "");
            ...
            if (FileOK)
            {
                try
                {
                    NewsVideoLogoFile.PostedFile.SaveAs(physicalpath + ImageUploadFolder + NewsVideoLogoFile.PostedFile.FileName.Replace(" ", ""));
                    FileSaved = true;
                }
                catch (Exception ex)
                {
        ...
        protected void ddlAction_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlSelectedValue == "Edit")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txtVideoPath.Text = dt.Rows[0]["VideoPath"].ToString();
