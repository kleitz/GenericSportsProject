    ...
    <asp:GridView ID="gvPicture" runat="server" 
        ...
        <Columns>
         ...
         <asp:TemplateField HeaderText="PictureId" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" 
            ...
            <asp:TemplateField HeaderText="Picture Title" HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column">
                <ItemTemplate>
                    <div class="grid-cell-inner" style="width:500%; display: inline-block;">
                        <asp:Label ID="lblPictureTitle" runat="server" Text='<%#Eval("PictureTitle") %>'></asp:Label>
                    </div> 
                </ItemTemplate>
         </asp:TemplateField>
