<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmCompetitionTeam.ascx.cs" Inherits="DotNetNuke.Modules.ThSport.frmCompetitionTeam" %>
...
<div id="divcancelmassage" runat="server" clientidmode="static" style="display: none;position:inherit !important;">
    ...
    <div id="dialogBox" runat="server" clientidmode="static" style="display:none;">
        <div class="lobibox-body-text-wrapper">
            <asp:Label CssClass="lobibox-body-text" ID="msgConfirm" ClientIDMode="Static" runat="server" Text="Are You Sure, You Want to Save Competition Team ?"></asp:Label>
        </div>
    </div>
...
<asp:Panel ID="pnlTeamList" runat="server" >
   ...
   <div style="position: relative;float: right;padding-top: 15px;margin-right: -7.9px;">
         <asp:Button ID="btnGoToCompetition" runat="server"  Text="Back" OnClick="btnGoToCompetition_Click" CssClass="btn blue back_btn_Position" />
    </div>
	...
	<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="hidden-480">
                        <asp:Label ID="lbl_Competition_Name" runat="server"></asp:Label>
			            - Teams
					</span>
				</div>
                 <div class="tools">
		...
		<Columns>
        	...
        	<asp:TemplateField HeaderText="Competition Name" HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="170px" Visible="false">
				<ItemTemplate>
                <div class="grid-cell-inner" style="width:180px; display: inline-block;">
					<asp:Label ID="lblCompetitionName" runat="server" Text='<%#Eval("CompetitionName") %>' ToolTip="Competition Name"></asp:Label>
                 </div> 
				</ItemTemplate>
			</asp:TemplateField>

           	<asp:TemplateField HeaderText="Group Name" HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30%" ItemStyle-Width="30%">
				<ItemTemplate>
                <div class="grid-cell-inner">
					<asp:Label ID="lblGroupName" runat="server" Text='<%#Eval("CompetitionGroupName") %>' ToolTip="Competition Group Name"></asp:Label>
                    </div> 
				</ItemTemplate>
			</asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Action"  HeaderStyle-CssClass="grid-header-column" ItemStyle-CssClass="grid-column" 
                ...
                <ItemTemplate>
                    <asp:DropDownList ID="ddlAction" runat="server" CssClass="small m-wrap ddlActionSelect" OnSelectedIndexChanged="ddlAction_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <asp:HiddenField ID="hdnCompetitionTeamID" runat="server" Value='<%#Eval("CompetitionTeamId") %>'></asp:HiddenField>
...
<asp:HiddenField ID="hdn_CompetitionTeamID" runat="server" />
            ...
            <div class="tab-pane active" id="portlet_tab1">
              ...
              <%--<div class="control-group">
		        <label class="control-label">
                    <asp:Label ID="lblSelectCompetition" runat="server" Text="Competition :"  Visible="false"></asp:Label>
                </label>
                <div class="controls" style="position:relative;">
                    <asp:DropDownList ID="ddlSelectCompetition" runat="server" CssClass="medium m-wrap" Visible="false"
                                      AutoPostBack="true" OnSelectedIndexChanged="ddlSelectCompetition_SelectedIndexChanged">
                    </asp:DropDownList>
                </div>
              </div>--%>
                <div class="control-group">
		            <label class="control-label">
                        <asp:Label ID="lblCompetitionName" runat="server" Text="Competition :" ></asp:Label>
                    </label>
                    <div class="startsetallfrom">
                        <span class="help-inline"><font Color="red"><b>*</b></font></span>
                    </div>  
                    <div class="controls" style="position:relative;">
                        <asp:TextBox ID="txtCompetitionName" runat="server" CssClass="m-wrap large" Enabled="false"></asp:TextBox>
                         <asp:RequiredFieldValidator ID="rfvtxtCompetitionName" ClientIDMode="Static" runat="server"
                                    ErrorMessage="Competition Name," CssClass="errorfordnn" ControlToValidate="txtCompetitionName" 
                                    ValidationGroup="Sports"
                                    Text=" Competition Name !"></asp:RequiredFieldValidator>
                    </div>
                </div>
